		...
		<div class="card-columns" style="padding-left: 135px;">
			...
			<div class="card mb-3" >
				...
				<div class="card-body">
					...
					<p class="card-text small" style="font-family: Garamond; font-size: 25px;"><?php echo $Description ?> <br>
					</p>
				</div>

				<hr class="my-0">
				<div class="card-body py-2 small"  style=" font-size: 15px;">
					...
					if($req=="")
					{
						...
						<div id="myModal" class="modal fade" role="dialog">
							<div class="modal-dialog">
								...
								<div class="modal-content">
									<div class="modal-header"  style="background: #337ab7; color: white;">
									<center><h4 class="modal-title" style="font: 400 30px/1.3 'Berkshire Swash', Helvetica, sans-serif;"> Buy Pin</h4></center>
										<button type="button" class="close" data-dismiss="modal" style="position: absolute; right: 5px; color: white;">&times;</button>
									</div>
									<div class="modal-body">
										...
										<script type="text/javascript">
											...
											<div class="form-group">
											  <div class="col-sm-offset-2 col-sm-10">
											    <input type="submit" class="btn btn-default">Buy Pin!</input>
											  </div>
											</div>
										</form>
									</div>
						...
						{	
							...
							<div id="requestsent" class="modal fade" role="dialog">
							  <div class="modal-dialog">
							    ...
							    <div class="modal-content">
							      <div class="modal-header" style="background: #337ab7; color: white;">
							      <center><h4 class="modal-title" style="font: 400 30px/1.3 'Berkshire Swash', Helvetica, sans-serif;"> Buy Requests</h4></center>
							        <button type="button" class="close" data-dismiss="modal" style="position: absolute; right: 5px; color: white;">&times;</button>
							      </div>
							      <div class="modal-body">
							        <p>Quantity: <?php echo $row_reqsent['Quantity']; ?></p>
