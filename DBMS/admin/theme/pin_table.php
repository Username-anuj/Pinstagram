...
<!--       Example DataTables Card -->
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Pinstagram Pins</div>
        <div class="card-body">
        <a href="../root_pins.php">Show all</a>
            ...
            <table class="asdfgh table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              ?>
                <tr bgcolor="<?php if($row_pins['Status']==0){echo "red";}else{ echo "white"; } ?>">
                        ...
                        <td><a href="../../showpin/viewpin.php?pid=<?php echo $row_pins['PinId']; ?>"><?php echo $row_pins['Pic']; ?></a></td>
