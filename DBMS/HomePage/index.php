	...
	<div class="container">
				...
				<p class="content-subtitle"> 
					<button type="button" class="button" > 
						<h2 style="color: white; width: 100%; font-size: 2.5vh; font-weight: bold; font-family: Garamond;">
							<b><a href="../../var/www/html/DBMS_NEW/DBMS/signup/signup.php">Get Started</a></b>
						</h2>
					</button>
				</p><br><br>
				<p class="content-subtitle"> 
		...
		<section class="background">
			<div class="content-wrapper">
				...
				<img src="Pin4.jpg" style="border-top-left-radius:40px; border-top-right-radius:40px; width:320px; height: 90px; position: absolute; top: 840px;  " class="imgtrans1">
				<img src="Pin1.jpg" style="border-bottom-left-radius:40px; border-bottom-right-radius:40px; width:320px; height: 270px; position: absolute; top: 240px; left: 350px;" class="imgtrans2">
				<img src="Pin2.jpg" style="border-top-left-radius:40px; border-top-right-radius:40px; width:320px; height: 220px; position: absolute; top: 540px; left: 350px; " class="imgtrans3">
		...
		<section class="background">
			<div class="content-wrapper">
				...
				<img src="Pic1.jpg" style="width: 120px; height: 120px; border-radius: 60%; position: absolute; top: 100px; left: 500px;"> <h4 style="position: absolute; top: 225px; left: 520px;"> <strong> Description </strong> </h4>

<img src="Pic2.jpg" style="width: 120px; height: 120px; border-radius: 60%; position: absolute; top: 100px; left: 630px;"> <h4 style="position: absolute; top: 225px; left: 665px;"> <strong> Image </strong> </h4>

<img src="Pic3.jpg" style="width: 120px; height: 120px; border-radius: 60%; position: absolute; top: 100px; left: 760px;"> <h4 style="position: absolute; top: 225px; left: 780px;"> <strong> Comments </strong> </h4>

<img src="Pic5.jpg" style="width: 120px; height: 120px; border-radius: 60%; position: absolute; top: 250px; left: 400px;"> <h4 style="position: absolute; top: 380px; left: 400px;"> <strong> Advertisements </strong> </h4>

<img src="Pic4.jpg" style="width: 120px; height: 120px; border-radius: 60%; position: absolute; top: 250px; left: 550px;"> <h4 style="position: absolute; top: 380px; left: 580px;"> <strong> Connect  </strong> </h4>

<img src="Pic6.jpg" style="width: 120px; height: 120px; border-radius: 60%; position: absolute; top: 250px; left: 690px;"> <h4 style="position: absolute; top: 380px; left: 710px;"> <strong> Categories  </strong> </h4>

<img src="Pic7.jpg" style="width: 120px; height: 120px; border-radius: 60%; position: absolute; top: 250px; left: 840px;"> <h4 style="position: absolute; top: 380px; left: 860px;"> <strong> Boards  </strong> </h4>
...
function checkAnimation() {
	var $elem = $('.content-wrapper .imgtrans');
